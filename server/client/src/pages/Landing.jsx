...
const Landing = () => {
  return (
    <div className="font-[Montserrat] flex flex-col items-center justify-center h-screen w-screen gap-7 bg-gray-100">
      <h1 className="text-6xl font-bold flex items-center gap-5">Welcome to <p className='text-blue-600'>Tasker</p></h1>
      <p className="text-lg text-center ">
        Manage your tasks efficiently and stay organized.
      </p>
      <div className='flex items-baseline justify-center gap-6 p-2'>
      ...
      <Link
        href="https://github.com/sreyas-b-anand/sreyas-b-anand" 
        target="_blank"
